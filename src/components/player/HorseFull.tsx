...
const HorseFull = (props: JSX.IntrinsicElements['group']) => {
  const group = useRef<THREE.Group>(null)
  const { nodes, materials, animations } = useGLTF('/models/horse-full.glb') as GLTFResult
...
useGLTF.preload('/models/horse-full.glb')

export default HorseFull
